...
class preprocess():
    ...
    def load_data():
        print(inputsthree)
        NOTEEVENTS=pd.read_csv(inputsthree,dtype={'ROW_ID':np.int32, 'SUBJECT_ID': np.int32,'HADM_ID': np.float64, 
        ...
        DIAGNOSES_ICD=pd.read_csv(inputstwo,dtype={'ROW_ID':np.int32, 'SUBJECT_ID': np.int32,'HADM_ID': np.int32,
